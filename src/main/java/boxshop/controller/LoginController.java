...
public class LoginController {
    ...
    public String recuperarSenhaPag(@RequestParam(required = false) String token,
                                    Model model) {
        model.addAttribute("token", token);
        return "recuperarSenha"; // Vai renderizar recuperarSenha.html com o token disponível
    }
